...
#include "TestShooterNPC.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE(FTestShooterNPCDeathDelegate);
 ...
 */
UCLASS(abstract)
class PROJECTTENQKCAMP_API ATestShooterNPC : public AProjectTenQKCampCharacter, public IShooterWeaponHolder
{
	GENERATED_BODY()
...
public:
	...
	FTestShooterNPCDeathDelegate OnPawnDeath;
